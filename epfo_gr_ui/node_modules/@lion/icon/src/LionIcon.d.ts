...
export class LionIcon extends LitElement {
     ...
     */
    set svg(arg: typeof nothing | import("@lion/core").TemplateResult<1 | 2> | ((tag: (strings: TemplateStringsArray, ...expr: string[]) => string) => string));
    /**
     * @type {TemplateResult|nothing|TagFunction}
     */
    get svg(): typeof nothing | import("@lion/core").TemplateResult<1 | 2> | ((tag: (strings: TemplateStringsArray, ...expr: string[]) => string) => string);
    /** @protected */

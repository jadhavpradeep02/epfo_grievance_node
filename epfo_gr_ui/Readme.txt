...
### This setup will guide you how to run the Front-End code for Grievance App.

`Note : You must have main backend api service running in background before running front-end app ( refer main Readme of this project) `
